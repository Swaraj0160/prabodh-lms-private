...
export const metadata: Metadata = {
  title: 'Terms of Service — Prabodh',
}

// Placeholder page. Real Terms of Service content has not been supplied yet —
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-16">
      <div className="max-w-lg text-center">
        <h1 className="text-2xl font-bold text-gray-900 mb-3">Terms of Service</h1>
        <p className="text-gray-600 leading-relaxed">
          Prabodh&apos;s Terms of Service are being finalized and will be published here.
        </p>
